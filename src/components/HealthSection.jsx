  ...
  return (
    ...
    >
      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[1.8rem] border border-white/[0.08] bg-white/[0.03] p-5 shadow-[0_16px_45px_rgba(0,0,0,0.3)] sm:p-8 lg:sticky lg:top-28">
          <div className="font-display text-[clamp(1.8rem,3vw,2.8rem)] leading-[1.15] text-goldLight">
